              ...
              children: [
                  ...
                  titleIcon: IconButton(
                      ...
                      onPressed: () => customDialog(
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                controller.updateScheduleColor(
                                    controller.editingSchedule.sectionColor);
                                Get.back();
                              },
                            ),
                          )),
                  ...
                  children: [
                    Expanded(
                      ...
                      child: CustomTextFormField(
                        ...
                        isReadOnly: true,
                        onTap: () {
                          pickDate(context: context, isStartTime: true);
                        },
                        titleIcon: IconButton(
                            icon: Icon(
                        ...
                        hintText: DateFormat.yMd()
                            .format(controller.editingSchedule.from),
                        hintStyle: controller.editingSchedule.to
                                .isBefore(controller.editingSchedule.from)
                  ...
                  children: [
                    Expanded(
                      ...
                      child: CustomTextFormField(
                        ...
                        isReadOnly: true,
                        onTap: () {
                          pickDate(context: context, isStartTime: false);
                        },
                        titleIcon: IconButton(
                            icon: Icon(
                              Icons.edit_calendar_outlined,
                            ...
                            onPressed: null),
                        hintText: DateFormat.yMd()
                            .format(controller.editingSchedule.to),
                        hintStyle: controller.editingSchedule.to
                                .isBefore(controller.editingSchedule.from)
                            ? TextStyle(color: ColorBox.darkRed)
                            : const TextStyle(),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text('하루 종일',
                          style: FontBox.B1.copyWith(letterSpacing: 1)),
                ...
                Row(
                  ...
                  children: [
                    const Padding(
                      ...
                      child:
                          Icon(Icons.sticky_note_2_outlined, size: IconSize.md),
                    ),
