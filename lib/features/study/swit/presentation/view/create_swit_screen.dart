      ...
      appBar: CustomBackAppBar(
        ...
        actions: [
          Obx(() =>
              TextButton(
                  onPressed: () {
                    controller.selectedUsers.isNotEmpty ? _createGroup() : null;
                  },
                  child: Text('초대', style: controller.selectedUsers.isNotEmpty ? FontBox.activtedActions : FontBox.disabledActions)))
        ],
      ),
      body: Padding(
